...
const AdminDashboard = () => {
    const {requests,updateRequest} = useContext(AdminContext);
    ...
    return (
      <div className="p-6 md:p-10 bg-gray-100 min-h-screen">
              ...
              newRequests.map((req, idx) => (
                <div key={idx} className="flex items-center justify-between p-4">
                  ...
                  <div className="flex items-center w-[20%] justify-around">
                    <button onClick={()=>{setStatus("approved"); updateRequest("approved", req.flightNumber)} } className="text-md font-semibold text-white bg-green-500 py-1 px-2 cursor-pointer rounded">Approve</button>
                    <button onClick={()=>{setStatus("rejected"); updateRequest("approved", req.flightNumber)}} className="text-md font-semibold text-white bg-red-500 py-1 px-2 cursor-pointer rounded">Cancel</button>
                  </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch justify-between mt-6 w-full">
